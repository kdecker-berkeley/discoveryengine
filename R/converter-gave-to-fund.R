...
#' donors at any time. Giving is aggregated to all funds in \code{savedlist} --
...
#'
#' @seealso \code{\link{gave_to_area}}, \code{\link{gave_to_department}}, \code{\link{fund_text_contains}}
#' @export
